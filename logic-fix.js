(()=>{
'use strict';
if(window.__BUTIAN_LOGIC_FIX_RUNTIME_K__)return;
window.__BUTIAN_LOGIC_FIX_RUNTIME_K__=true;
// 2026-08-18k 居中报告查看器、自由文本宽容判定与全流程稳定性修复
...
window.__BUTIAN_LOGIC_FIX__={version:'20260818k',readStored,confirmedEvents,confirmedInjuries,advanceTo,reportUnlocked,openReportArchive,NIGHT_REPORTS,localHitsFor,directionalPass,feedbackFor,questionIdFromOverlay};
})();
